...
public class EnrollmentControllerTest {
    ...
    public void getEnrollments_by_date_success() throws Exception {
        ...
        Mockito.when(enrollmentRepository.findByEnrollmentDate(eq(dateInput))).thenReturn(enrollments);
    ...
    public void editEnrollment_fail() throws Exception {
        ...
        Mockito.when(enrollmentRepository.save(eq(newEnrollment))).thenReturn(null);
    ...
    public void deleteEnrollmentDetail_fail() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .delete("/v1/enrollments/details/1/courses/9")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", Matchers.is(false)));
    }
